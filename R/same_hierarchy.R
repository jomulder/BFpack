...
#' (in the column) work in the same hierarchical position. Related to the 'events' data object,
...
#' @name same_hierarchy
#' @docType data
#' @usage data(same_hierarchy)
#' @format dataframe (25 rows, 4 columns)
#'
#' \tabular{lll}{
#'    \strong{same_hierarchy} \tab \code{integer} \tab Event statistic. Matrix with senders in the
#'    rows and receivers in the columns. The event statistic is 1 if sender and receiver work 
#'    in the same hierarchical position and 0 otherwise. \cr
#' }
#' 
