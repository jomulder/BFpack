...
#'
#' \tabular{lll}{
#'    \strong{time} \tab \code{numeric} \tab Time of the e-mail message,
#'    in seconds since onset of the observation \cr
#'    \strong{sender} \tab \code{integer} \tab ID of the sender, corresponding to
#'    the employee IDs in the actors dataframe \cr
#'    \strong{receiver} \tab \code{integer} \tab ID of the receiver \cr
#' }
#'
