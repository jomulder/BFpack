...
cor_test <- function(..., formula = NULL, iter = 5e3, burnin = 3e3, nugget.scale = .995){
  ...
  res <- .Fortran("estimate_bct_ordinal",
                  ...
                  CheckStore = array(as.double(1),dim=c(samsize0,numG,Ntot,P,9*P))
  )
...
#'
#' }
#' @rdname cor_test_test
#' @export
cor_test_test <- function(..., formula = NULL, iter = 5e3, burnin = 3e3, nugget.scale = .995){
