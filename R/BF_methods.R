#' @title Bayes factors for Bayesian exploratory and confirmatory hypothesis testing
#' @description The \code{BF} function can be used for hypothesis testing and model
