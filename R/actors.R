...
#'
#' \tabular{lll}{
#'    \strong{id} \tab \code{integer} \tab ID of the employee, corresponding to
#'    the sender and receiver IDs in the events dataframe \cr
#'    \strong{position} \tab \code{numeric} \tab Hierarchical position of the
#'    employee, ranging from 1-4 \cr
#'    \strong{division} \tab \code{character} \tab Categorical variable,
#'    indicating the division of the employee \cr
#'    \strong{location} \tab \code{integer} \tab Categorical variable,
#'    indicating the location of the building the employee works in \cr
#' }
#'
