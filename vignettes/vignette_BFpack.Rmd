...
`BF(x, hypothesis, prior = NULL, complement = TRUE, ...)`
...
* `prior`, a numeric vector specifying the prior probabilities of the hypotheses. The default setting is `prior = NULL` which sets equal prior probabilities.
