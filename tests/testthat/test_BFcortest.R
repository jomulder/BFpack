...
draw1 <- 1
print(draw1)
print(cor1$res$CheckStore[draw1,1,1,,])
print(cor1$res$CheckStore[draw1,1,2,,])
print(cor1$res$CheckStore[draw1,1,3,,])
print(cor1$res$CheckStore[draw1,1,4,,])
print(cor1$res$CheckStore[draw1,1,5,,])
print(cor1$res$CheckStore[draw1,1,6,,])
print(cor1$res$CheckStore[draw1,1,7,,])
print(cor1$res$CheckStore[draw1,1,8,,])
print(cor1$res$CheckStore[draw1,1,9,,])
print(cor1$res$CheckStore[draw1,1,10,,])
draw1 <- 2
print(draw1)
print(cor1$res$CheckStore[draw1,1,1,,])
print(cor1$res$CheckStore[draw1,1,2,,])
...
print(head(cor2$res$CheckStore[1e3,1,1,,],2))
print(head(cor2$res$CheckStore[1e3,1,2,,],2))
# print(cor2$meanF)
# print(cor2$covmF)
