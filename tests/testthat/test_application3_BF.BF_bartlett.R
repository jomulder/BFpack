...
test_that("var_test works for an exploratory test of equality of variances", {
expect_equivalent(
...
test_that("names match of output for a var_test", {
expect_equivalent(
...
test_that("var_test works for a specific conformator test of equality of variances", {
expect_equivalent(
